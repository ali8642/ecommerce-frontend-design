...
function Discount() {
  return (
    <div className="w-[90%] rounded m-auto text-white flex justify-between items-center bg-blue bg-[url(/images/Rectangle-176.png)] bg-cover bg-center bg-no-repeat">
